   ...
   <!--     <div class="contenaire">
         ...
         <div class="container">
            <h1>Inscription</h1>
                ...
                <form action="{{URL::to('/creer_compte')}}" method="POST" class="register-form" id="register-form">
             {{ csrf_field() }}
            <label for="nom">Nom :</label>
            <input type="text" id="nom" name="nom" required>
            ...
            <input type="text" id="ntel" name="adresse" required>

            <label for="ntel">numero telephone :</label>
            <input type="telephone" id="ntel" name="ntel" required>
